        ...
        <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
            ...
            <div className="p-4 space-y-4">
                <div className="space-y-1.5">
                    <Label htmlFor="nominee_name" className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Full Name *</Label>
                    <Input
                        id="nominee_name"
                ...
                <div className="space-y-1.5">
                    <Label htmlFor="nominee_relation" className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Relationship *</Label>
                    <Input
                        id="nominee_relation"
                        value={form.relation}
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                        <Label htmlFor="nominee_age" className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Age *</Label>
                        <Input
                            id="nominee_age"
                            type="number"
                            value={form.age}
                    ...
                    <div className="space-y-1.5">
                        <Label htmlFor="pan_number" className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">PAN *</Label>
                        <Input
                            id="pan_number"
