...
export const FormReviewStep = ({ customerForm, jobForm, medicalForm, familyMembers, policyForm }) => {
    ...
    const nominee = policyForm.nominee || {};
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <InfoItem label="Nominee Name" value={nominee.nominee_name} />
                    ...
                    <div className="max-h-32 overflow-y-auto space-y-2">
                        {familyMembers.map((m, i) => (
                            <div key={i} className="text-xs bg-slate-50 p-2 rounded border border-slate-100 flex justify-between">
                                ...
                                <span className="text-slate-500">{m.age} Years</span>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <InfoItem label="Maturity" value={`${policyForm.maturity_years} Years`} />
                    </div>
                </div>
            </div>
        </div>
